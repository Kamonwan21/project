...
import 'package:flutter_application_1/model/Page1.dart';
          ...
          children: [
            OutlinedButton(
              onPressed: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                      builder: (context) => Page1(title: "items_talk" 
                      )),
                );
              },
              child: Column(
            ...
            OutlinedButton(
              onPressed: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                      builder: (context) => Page1(title: "items_eat")),
                );
              },
              child: Column(
                children: [
            ...
            OutlinedButton(
              onPressed: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                      builder: (context) => Page1(title: "items_feeling")),
                );
              },
              child: Column(
                children: [
            ...
            OutlinedButton(
              onPressed: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                      builder: (context) => Page1(title: "items_items")),
                );
              },
              child: Column(
                children: [
            ...
            OutlinedButton(
              onPressed: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                      builder: (context) => Page1(title: "items_hobby")),
                );
              },
              child: Column(
                children: [
